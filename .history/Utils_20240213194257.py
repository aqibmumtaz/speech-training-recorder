...
_wav_file_ = "./output/recorder_2024-02-13_19-09-21_358209.wav"


def load_wav_file(_wav_file_="output/recorder_2024-02-13_19-09-21_358209.wav"):
    return librosa.load(_wav_file_, sr=None, mono=True, dtype=np.float32)


def spectogram_librosa(_wav_file_="output/recorder_2024-02-13_19-09-21_358209.wav"):
    import librosa
    import pylab
    import numpy as np
...
load_wav_file(_wav_file_="output/recorder_2024-02-13_19-09-21_358209.wav")
